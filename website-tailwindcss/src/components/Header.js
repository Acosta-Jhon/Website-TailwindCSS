        ...
        <div className="leading-normal tracking-normal h-40">
            <nav className="flex items-center justify-center flex-wrap fixed w-full z-10 top-0 py-12 lg:pl-32 md:pl-32 bg-gray-800 bg-opacity-50">
                ...
                <div className="w-full flex-grow lg:items-center md:items-center lg:w-auto md:w-auto hidden lg:block md:block lg:pt-0 " id="nav-content">
                        <ul className="list-reset lg:flex md:flex justify-start flex-1 items-center h-screen md:h-auto lg:h-auto">
                            <li className="mr-0">
