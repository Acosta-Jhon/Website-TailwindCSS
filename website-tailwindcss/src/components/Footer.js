...
const Footer = () => {
    return (
        ...
        <div class="container h-full md:max-w-screen-md lg:max-w-screen-xl m-auto px-5 md:px-20 pb-12 pt-24">
            <div class="container max-w-screen-xl mx-auto pt-16 text-gray-50">
                <h1 class="text-3xl font-semibold text-center text-purple-400"> Ponte al contacto
                <span role="img" aria-label="wave">👋</span>
                </h1>
                <p class="px-4 mt-4 text-center text-secondary">No dudes en enviarme un correo electrónico sobre cualquier tema. ¿Quieres un consejo?</p>
                <p class="px-4 mt-1 text-center text-secondary">También puedes comunicarte conmigo en:
                <a class="font-medium text-accent hover:text-accent hover:underline text-red-600" target="_blank" rel="noopener noreferrer"> GitHub </a>
                <a class="font-medium text-accent hover:text-accent hover:underline text-red-600" target="_blank" rel="noopener noreferrer"> Twtter </a>
                <a class="font-medium text-accent hover:text-accent hover:underline text-red-600" target="_blank" rel="noopener noreferrer"> Instagram </a>
                </p>
            </div>
            <div class="mx-auto pt-10 flex justify-center text-gray-50 ">
                <a class="bg-green-500 px-20 py-2 rounded accent-gradient text-on-accent" target="_blank" rel="noopener noreferrer" href="/">
                    <span class=" text-2xl font-semibold text-on-accent">
                        Enviar saludo
                    </span>
                </a>
            </div>

            <div class="container flex-col justify-between md:space-y-8">
                {/* navbar */}
                <nav class="hidden lg:flex flex-row items-center space-x-6 justify-center md:justify-end text-sm" >
                    <a aria-current="page" title="Home" href="/">
                    <span class="font-normal text-base hover:text-accent transition duration-150 text-secondary">Home</span>
                    </a>
                    <a title="Blog" href="/">
                        <span class="font-normal text-base hover:text-accent transition duration-150 text-secondary">Blog</span>
                    </a>
                    <a title="Projects" href="/">
                        <span class="font-normal text-base hover:text-accent transition duration-150 text-secondary">Proyectos</span>
                    </a>
                    <a title="About" href="/">
                        <span class="font-normal text-base hover:text-accent transition duration-150 text-secondary"> Otros</span>
                    </a>
                </nav>
                <div class="flex flex-col-reverse md:flex-row md:justify-between space-y-reverse space-y-8 md:space-y-0">

                    <span class="text-xs tracking-wider self-center md:self-end" aria-label="Copyright">© 2020 Jeff Jadulco. All Rights Reserved.</span>
                <div class="flex flex-row items-center space-x-4 justify-center md:justify-end">
                    <span>
                        <a title="Email"  href="/">
                            <svg aria-hidden="true" class="h-8 w-8 text-secondary hover:text-accent transition duration-100" fill="currentColor" 
